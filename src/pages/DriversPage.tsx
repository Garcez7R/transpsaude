...
export function DriversPage() {
  ...
  const [activeTab, setActiveTab] = useState<'motoristas' | 'veiculos' | 'operadores' | 'pacientes'>('motoristas')
  ...
  return (
    <div className="dashboard-shell internal-shell">
      ...
      <div className="content-tabs" role="tablist" aria-label="Seções de equipe e veículos">
        <button
          type="button"
          role="tab"
          className={activeTab === 'motoristas' ? 'is-active' : ''}
          aria-selected={activeTab === 'motoristas'}
        ...
        <button
          type="button"
          role="tab"
          className={activeTab === 'veiculos' ? 'is-active' : ''}
        ...
        <button
          type="button"
          role="tab"
          className={activeTab === 'operadores' ? 'is-active' : ''}
          aria-selected={activeTab === 'operadores'}
        ...
        <button
          type="button"
          role="tab"
          className={activeTab === 'pacientes' ? 'is-active' : ''}
      ...
      {activeTab === 'motoristas' ? (
        <>
          ...
          <section className="dashboard-grid dashboard-grid-single fleet-forms-grid">
          ...
          <section className="dashboard-grid dashboard-grid-single fleet-lists-shell">
